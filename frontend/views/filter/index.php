            ...
            <div class="ih-item circle effect3 left_to_right">
                <div class="ih-item-hover">
                    ...
                    <div class="buttons">
                        ...
                        <a href="/<?=$service->category->slug?>/<?=$service->slug?>" class="view_btn btn-floating btn-large waves-effect waves-light" data-tooltip="Daha ətraflı"><i class="zmdi zmdi-hc-3x zmdi-search"></i></a>
                    </div>
                </div>
            </div>
        </div>
